...
import { ProductoNavigator } from "./ProductoNavigator";
import { StackNavCute } from "./StackNavCute";
...
export type RootDrawerNavigator = {
    ...
    ProductoNavigator: undefined;
    StackNavCute: undefined;
}
...
const Navigator = () => {
    ...
    return( 
        ...
        >
            ...
            <Drawer.Screen
                name="ProductoNavigator"
                component={ProductoNavigator}
            />

            <Drawer.Screen
                name="StackNavCute"
                component={StackNavCute}
            />
